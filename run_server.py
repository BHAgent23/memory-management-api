...
def main():
    ...
    # Test database connection - make it optional for Render deployment
    try:
        ...
        logger.info("Continuing startup - database will be tested on first request")

    # Server configuration - Use PORT environment variable for Render
    host = os.getenv("MEMORY_API_HOST", "0.0.0.0")
    port = int(os.getenv("PORT", os.getenv("MEMORY_API_PORT", "8003")))
